...
function pm_admin_options() {
    ...
    <h3>What is Postmark?</h3>
		<p>Postmark enables Wordpress blogs of any size to deliver and track Wordpress notification emails reliably, with minimal setup time and zero maintenance. </p>
